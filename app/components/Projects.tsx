...
const projects = [
  ...
  },
  {
    ...
    title: "NezAI",
    description:
      "An AI-powered personal engineering platform designed to combine a professional portfolio with a personal AI agent. The project explores practical AI integration alongside backend engineering.",
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 text-base leading-7 text-zinc-400">
            A selection of backend and AI engineering projects that
            document how I build, learn, and reason through problems.
          </p>
        </div>
